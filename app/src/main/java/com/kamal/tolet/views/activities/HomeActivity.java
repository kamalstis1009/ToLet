...
import com.kamal.tolet.services.MyLocationReceiver;
...
import com.kamal.tolet.utils.GpsUtility;
import com.kamal.tolet.utils.Utility;
import com.kamal.tolet.utils.language.LocaleHelper;
import com.kamal.tolet.utils.network.Network;
import com.kamal.tolet.viewmodels.PostAdViewModel;
import com.kamal.tolet.views.adapters.MarkerInfoAdapter;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    private RangeSlider filterPriceRange;
    ...
    protected void filterDialog() {
        ...
        this.filterPriceRange = (RangeSlider) view.findViewById(R.id.filter_price_range);
        final EditText min = view.findViewById(R.id.range_min);
        final EditText max = view.findViewById(R.id.range_max);
        filterPriceRange.setLabelFormatter(new LabelFormatter() {
            @NonNull
            @Override
            public String getFormattedValue(float value) {
                //min.setText(value.toString());
                //max.setText(value.toString());
