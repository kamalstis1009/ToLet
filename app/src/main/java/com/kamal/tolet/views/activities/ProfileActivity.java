...
import com.kamal.tolet.utils.PermissionUtility;
...
import com.kamal.tolet.viewmodels.UserViewModel;
            ...
            switch (view.getId()) {
                ...
                case R.id.saveButton:
                    ...
                    if (TextUtils.isEmpty(name) && TextUtils.isEmpty(phone) && mPhone != null) {
                        ...
                        layoutPhone.setError("length must be 14 digits");
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            try {
                ...
                if (photoFile != null) {
                    Uri photoURI = FileProvider.getUriForFile(this, "com.kamal.tolet", photoFile);
